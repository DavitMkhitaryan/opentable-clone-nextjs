...
import { partySize as partySizeData, times } from "../../../../data";
      ...
      <div className="flex justify-between">
        <div className="flex flex-col w-[48%]">
          ...
          <DatePicker
            ...
            className="py-3 border-b font-light text-reg w-16"
            dateFormat="MMMM d"
          ...
          <div className="flex flex-wrap mt-2">
            {data.map((time) => {
              return time.available ? (
                ...
                <div key={time.time} className="bg-gray-300 p-2 w-24 mb-3 rounded mr-3">
                </div>
              );
            })}
          </div>
